...
def _check_fixtures() -> list[str]:
    ...
    required = [
        ...
        FIXTURES / "invalid" / "threat-leverage-empty.yaml",
        FIXTURES / "invalid" / "threat-impact-semicolon.yaml",
        FIXTURES / "invalid" / "threat-leverage-high.yaml",
        FIXTURES / "invalid" / "threat-actors-string-list.yaml",
        FIXTURES / "invalid" / "threat-actors-not-list.yaml",
